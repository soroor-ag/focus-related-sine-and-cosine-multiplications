...
HD_PWD='D:/delay line/x_focus/x_focus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x_focusal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x_focusal.tcl
